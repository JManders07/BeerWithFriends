    ...
    <div>
      <b-navbar toggleable="lg" type="dark" variant="dark">
        ...
        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav>
            <b-nav-item class="first-link"
              ><router-link class="nav-link" to="/"
                >Home</router-link
              ></b-nav-item
            >
            <b-nav-item class="space"
              ><router-link class="nav-link" to="/beers"
                >Beers</router-link
              ></b-nav-item
            >
            <b-nav-item class="space"
              ><router-link class="nav-link" to="/create"
                >New Beer</router-link
              ></b-nav-item
            >
          </b-navbar-nav>
          ...
          <b-navbar-nav class="ml-auto right-side">
            <b-navbar-nav>
              <div v-if="!$auth.loading">
                ...
                <b-button v-if="$auth.isAuthenticated" variant="secondary">
                  <a @click="logout"><strong>Log out</strong></a></b-button
                >
              </div>
            </b-navbar-nav>
          </b-navbar-nav>
